...
//   }
// })
var PIXABAY_API_KEY = '9324111-d9394a0e56f6eb524da75f703';
var PIXABAY_RANDOM_DOG_URL = "https://pixabay.com/api/?key=".concat(PIXABAY_API_KEY, "&q=dog&image_type=photo&orientation=horizontal&per_page=200&editors_choice=true");
var DOG_API_RANDOM_URL = 'https://dog.ceo/api/breeds/image/random';
fetch(DOG_API_RANDOM_URL).then(function (response) {
...
var bgImg = document.querySelector('.bg-img-container');
fetch(PIXABAY_RANDOM_DOG_URL).then(function (response) {
  var responseJSON = response.json();
  return responseJSON;
}).then(function (responseJSON) {
...
},{}],"C:/Users/KM/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/KM/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","script.js"], null)
